...
session_start();
   include 'db.php';
$query = "SELECT * FROM uploader ORDER BY id DESC";
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
    ...
    <h4 class="modal-title">Post Meeting Form</h4>
   </div>
   <div class="modal-body">
    <form method="post" id="insert_form">
     ...
     <br />
     <label>Enter resolution uploader name:</label>
     <textarea name="address" id="address" class="form-control"></textarea>
     <br />
     
     <label>Enter discussion uploader name:</label>
     <input type="text" name="designation" id="designation" class="form-control" />
     <br />  
     <label>Enter follow_up uploader name:</label>
